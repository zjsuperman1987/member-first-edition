    ...
    return {
        init: function() {
            ...
            dayArray.forEach(function(item) {
                ...
                document.querySelector('.calendar-bottom').appendChild(div);
            ...
            function signToday() {
                ...
                document.querySelector('.sign-btn').removeEventListener('tap', signToday);
                howDate();
            }
            ...
            document.querySelectorAll('.thisMonth').forEach(function(item) {
                ...
                if (item.innerHTML == day.slice(1)) {
                    ...
                    if (item.classList.contains('sign-date')) {
                        ...
                        calendar.today = item;
                        document.querySelector('.sign-btn').addEventListener('tap', signToday);
